...
class LineChart {
    ...
    init = (data, dims, date) => {
        ...
        this.scales = new Scales(this.data, this.dims, this.date);
        ...
        this.lines = new Lines(this.chart, this.data, this.date, this.scales);
        this.tooltip = new Tooltip(this.tooltipDiv, this.data);
        this.circles = new Circles(this.chart, this.data, this.date, this.scales, this.tooltip);
    };

    updateDims = (newDims) => {
        this.dims.setDims(newDims);
        this.scales.setScales(this.data, this.dims, this.date);
